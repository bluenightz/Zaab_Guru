<div class="wrapper wrapper-content animated fadeInRight">
    <form action="<?php echo base_url('promotion/bank/insert'); ?>" method="post" class="form-horizontal">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Bank Promotion Type</label>
                            <div class="col-sm-4">
                                <select class="form-control" name="" id="promo_type">
                        ...
                        <div class="form-group m-b-lg">
                            <label class="col-sm-2 control-label" id="vary_to">Card Option</label>
                            <div class="col-sm-4">
                                <label class="multiple_title">Bank</label>
                                <select name="" id="" multiple class="form-control" data-payment_choice="payment_bank">
                            ...
                            <div class="col-sm-4">
                                <label class="multiple_title">Credit Card</label>
                                <select name="" id="" multiple class="form-control" data-payment_choice="payment_credit">
