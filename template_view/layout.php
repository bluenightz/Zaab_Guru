...
<body>
    <div id="wrapper">
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <?php $this->load->view("backend/partials/left_sidebar"); ?>
            </div>
        </nav>
    ...
    <script src="<?php echo base_url('assets/backend/'); ?>/js/banner.js"></script>
    ...
    <!-- Data picker -->
   <script src="<?php echo base_url('assets/backend/'); ?>/js/plugins/datapicker/bootstrap-datepicker.js"></script>

   <!-- Main Javascript -->
    <script src="<?php echo base_url('assets/backend/'); ?>/js/initial.js"></script>

   <?php echo $this->view('../../../gallery/views/api/detail_js'); ?>

    <script>
    Dropzone.options.emediaAwesomeDropzone = {
        maxFilesize: 2,
        init: function() {
            this.on("success", function(file, response) {
                // console.log(response);
                $("#emediaAwesomeDropzone").append("<input type='hidden' name='image_file_name[]' value='"+response+"'>"); /*$(element).remove();*/
             });
          }
    }
    ...
    $(document).ready(function(){
        ...
        $('#start_date .input-group.date, #end_date .input-group.date').datepicker({
            todayBtn: "linked",
   ...
   /* emediaAwesomeDropzone.on("complete", function(file) {
      alert("");
    });*/
        /*$(document).ready(function() {
            setTimeout(function() {
