        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="<?php echo (strtolower($menu) == 'new_banner') ? 'active':''; ?>">
                    <a href="#"><i class="fa fa-files-o"></i> <span class="nav-label">Banner </span><span class="fa arrow"></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="<?php echo base_url($project.'/backend/new_banner'); ?>">Listing</a></li>
                ...
                <li class="<?php echo (strtolower($menu) == 'promotion' || strtolower($menu) == 'betagro_video') ? 'active':''; ?>">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li><a href="<?php echo base_url($project.'/backend/betagro_video'); ?>">Betagro Video</a></li>
                    </ul>
                </li>
                ...
                <li  class="<?php echo ( preg_match("/^contact/", strtolower($menu))) ? 'active':''; ?>">
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li><a href="<?php echo base_url($project.'/backend/contact'); ?>">Contact Info</a></li>
                        <li><a href="<?php echo base_url($project.'/backend/contact_topic'); ?>">Contact Topic</a></li>
